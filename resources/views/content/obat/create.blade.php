...
@section('title', 'Tambah Detail Obat')
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Tambah Detail Obat</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('content.obat.store') }}" method="POST" id="form-pengingat">
                    @csrf
                    <div class="mb-3">
                        <label for="nama-obat" class="form-label">Nama Obat</label>
                        <input type="text" class="form-control" id="nama-obat" name="nama_obat" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="periode" class="form-label">Periode Minum Obat</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="aturan-minum" name="aturan_minum" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                <select class="form-select" id="lama-konsumsi" name="lama_konsumsi" required>
                                    @for ($i = 1; $i <= 31; $i++)
